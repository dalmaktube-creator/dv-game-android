...
- backoff نمایی با jitter: پایه ۱، ۲، ۴، ۸ و سقف ۱۵ ثانیه.
...
- هر مقدار معتبر `PersistentKeepalive` پنل بدون تغییر حفظ می‌شود.
- فقط مقدار صفر، غایب یا نامعتبر فعلاً با fallback محافظه‌کارانه ۲۵ ثانیه جایگزین می‌شود.
- سیاست ۱۵ ثانیه برای Cellular تا آزمون میدانی A/B تحمیل نمی‌شود.
...
- مسیر اجرایی GoBackend حذف شده، اما وابستگی WireGuard Android فعلاً فقط برای parser رسمی و آزموده‌شده حفظ شده است.
